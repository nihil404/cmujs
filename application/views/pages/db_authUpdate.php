...
<body>
    <div class="container">
        <h2>Edit Article</h2>
        <form action="<?php echo base_url('pages/updateNow/' . $article->slug) ?>" method="POST" enctype="multipart/form-data">
            ...
            <button type="button" class="cancel-button" onclick="window.location.href='<?php echo base_url('home/home_lp')?>'">Cancel</button>
