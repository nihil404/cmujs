        ...
        <div class="container position-relative px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <!-- Login Form-->
<div class="card">
<div class="card-header bg-white text-Black text-center fw-bold">Login</div>
    ...
    <div class="card-body">
        ...
        <?php 
            ...
            <p class="text-danger text-center" style="margin-top: 10 px;">
            <?=$this->session->flashdata('error')?> </p>

        
       <?php } ?>
        <div class="mt-3 text-center">
        <p>New here? <a href="<?php echo base_url('registration/signup'); ?>" >Create an account.</a></p>
    </div>
    </div>
</div>
