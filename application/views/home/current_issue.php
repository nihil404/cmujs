        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="post-heading">
                    <?php if(isset($articleData) && !empty($articleData)) : ?>
                        <?php foreach($articleData as $article) : ?>
                            <h1><?php echo $article->title; ?></h1>
                            <h2 class="subheading"><?php echo $article->keywords; ?></h2>
                            <span class="meta">
                                Posted by <a href="#!">Dave Chavez</a> on <?php echo date('F d, Y', strtotime($article->created_at)); ?>
                            </span>
                        <?php endforeach; ?>
                    <?php else : ?>
