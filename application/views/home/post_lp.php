...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        ...
        <header class="masthead" style="background-image: url('<?php echo base_url('assets/img/post-bg.jpg'); ?>')">                    <div class="container position-relative px-4 px-lg-5">
...
<article class="mb-4">
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <h2><?php echo $article->abstract; ?></h2>
                <form onsubmit="return confirmDelete(<?php echo $article->articleid; ?>)">
                    <button type="submit" class="btn btn-danger">Delete</button>
                </form>
                <br>
                <a href="<?php echo base_url('pages/db_authUpdate/' .$article->slug) ?>" class="btn btn-primary">Update</a>
            </div>
        </div>
    </div>
</article>
