...
<body>
    ...
    <a class="nav-link dropdown-toggle profile-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="<?php echo base_url('plugins/images/users/varun.jpg') ?>" alt="user-img" width="36" class="img-circle">
        <span class="text-white font-medium"><?php 
            if($this->session->userdata('UserLoginSession')) {
                $udata = $this->session->userdata('UserLoginSession');
                echo $udata['complete_name'];
            }  
        ?></span>
    </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('pages/articles') ?>" aria-expanded="false">
                        ...
                        <a href="#" class="btn btn-darkgreen text-white" target="_blank">MAKE A SUBMISSION</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="#" target="_blank" class="btn btn-darkgreen text-white d-none d-md-inline-block">CMU JS</a>                 
                        </div>
                    </div>
                </div>
            </div>
